...
@Component({
  selector: 'app-landingpage-blue',
  standalone: true,
  imports: [CarouselModule, ImageModule, FontAwesomeModule],
  templateUrl: './landingpage-blue.component.html',
  styleUrl: './landingpage-blue.component.scss',
  encapsulation: ViewEncapsulation.None
})
export class LandingpageBlueComponent implements OnInit {
